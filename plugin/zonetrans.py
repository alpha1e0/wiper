...
class ZoneTransPlugin(Plugin):
    ...
    def _handle(self, data):
        ...
        for line in records:
            if line[2] == "A":
                self.put(dict(url=line[0], ip=line[1], 
                    description="Generated by zonetrans plugin."))
            elif line[2] == "CNAME":
                self.put(dict(url=line[0], 
                    description="Generated by zonetrans plugin. Domain alias "\
                        +line[1]))
